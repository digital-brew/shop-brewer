...
/**
 * Plugin Name: Shop Brewer
 * Plugin URI: https://digitalbrew.io
 * Plugin Prefix: shop_brewer
 * Plugin ID: shop-brewer
 * Description: Add and remove WooCommerce options easy, with use of config file.
 * Version: 1.0.0
 * Author: DigitalBrew
 * Author URI: https://digitalbrew.io
 * Text Domain: shop-brewer
